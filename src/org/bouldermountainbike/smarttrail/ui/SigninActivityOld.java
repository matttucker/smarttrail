...
public class SigninActivityOld extends Activity {
	private static final String CLASSTAG = SigninActivityOld.class.getSimpleName();
	...
	private void setupUi() {
		...
		signupButton.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				if (false) {
					Intent intent = new Intent(SigninActivityOld.this,
	...
	private class SigninTask extends AsyncTask<Void, Void, Boolean> {
		...
		protected void onPostExecute(Boolean signedIn) {
			...
			if (signedIn) {
				...
				NotificationsUtil.ToastReasonForFailure(SigninActivityOld.this,
						mReason);
			}
