...
//	}
	 ...
	 */
	public static double distanceTo(LatLng start, LatLng finish) {

		double phi_s = Math.toRadians(start.latitude);
		double lambda_s = Math.toRadians(start.longitude);
		double phi_f = Math.toRadians(finish.latitude);
		double lambda_f = Math.toRadians(finish.longitude);
...
//	}
	...
	public static boolean isNear(LatLng start, LatLng finish, int radius) {
